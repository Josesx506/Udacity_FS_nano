...
# A db was setup manually with psql scripts from udacity which creates a new user student with password student
...
def setup_db(app, database_path=database_path):
    ...
    app.config["SQLALCHEMY_TRACK_MODIFICATIONS"] = False # This is not needed for SQLAlchemy 3.1.1
