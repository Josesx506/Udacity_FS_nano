...
def single_entry_db(app):
   ...
   event_1 =  Booking(first_name="Julius",
                      ...
                      start_time=datetime(today.year, today.month, 1, 12, 0),
                      completed=True,
                      stylist_id=1,
                      user_id='demo')
   event_2 =  Booking(first_name="Julius",
                      last_name='Agu',
                      phone='+4494041098',
                      email='jugu@gmail.com',
                      start_time=datetime(today.year, today.month, 1, 14, 0),
                      completed=True,
                      stylist_id=1,
                      user_id='demo')
   event_3 =  Booking(first_name="Julius",
                      last_name='Agu',
                      phone='+4494041098',
                      email='jugu@gmail.com',
                      start_time=datetime(today.year, today.month, 4, 12, 0),
                      completed=True,
                      stylist_id=1,
                      user_id='demo')
   event_4 =  Booking(first_name="Julius",
                      last_name='Agu',
                      phone='+4494041098',
                      email='jugu@gmail.com',
                      start_time=datetime(today.year, today.month, 6, 9, 0),
                      completed=True,
                      stylist_id=1,
                      user_id='demo')
   event_5 =  Booking(first_name="Elizabeth",
                      last_name='Tyler',
                      phone='+4494041098',
                      email='eller@yahoo.com',
                      start_time=datetime(today.year, today.month, 8, 14, 0),
                      completed=True,
                      stylist_id=1,
                      user_id='demo')
   event_6 =  Booking(first_name="Reina",
                      last_name='Akurus',
                      phone='+4494041098',
                      email='rerus@zinmo.com',
                      start_time=datetime(today.year, today.month, 4, 10, minute=0),
                      completed=False,
                      stylist_id=1,
                      user_id='demo')
