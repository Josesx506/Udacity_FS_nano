# This method can be used to send a login post request to our server
...
for i,test_pss in enumerate(nist_bad):
    if try_password(test_pss):
        break